...
class TestPluginManager:
    ...
    def setup_method(self):
        """
        Initializes a Console and PluginManager instance before each test.
        """
    ...
    def test_plugin_manager_initialization(self):
        """
        Verify that the plugin manager initializes with the correct console and a non-empty dictionary of plugins.
        """
    ...
    def test_load_known_plugins(self):
        """
        Verify that the plugin manager loads only the expected set of known plugins.
        
        Checks that the plugins "emfit", "oura", and "eight" are present and that no additional plugins are loaded.
        """
    ...
    def test_get_plugin_success(self):
        """
        Verify that retrieving the "emfit" plugin returns a valid SleepTrackerPlugin instance with the correct name.
        """
    ...
    def test_get_plugin_case_insensitive(self):
        """
        Verify that plugin retrieval by name is case-insensitive and returns the same plugin type regardless of input casing.
        """
    ...
    def test_get_plugin_nonexistent(self):
        """
        Verify that requesting a non-existent plugin returns None.
        """
    ...
    def test_plugin_loading_handles_import_errors(self, mock_logging):
        ...
        Simulates an ImportError when loading plugins and verifies that the PluginManager initializes with a valid plugins dictionary.
        """
    ...
    def test_cache_key_generation(self):
        """
        Verify that plugins generate unique cache keys prefixed with their plugin names to prevent collisions.
        
        This test ensures that different plugins produce distinct cache keys for the same device and date, and that each key includes the plugin's name as a prefix.
        """
        emfit_plugin = self.plugin_manager.get_plugin("emfit")
    ...
    def test_plugin_security_whitelist(self):
        """
        Verify that only plugins on the security whitelist ("emfit", "oura", "eight") are loaded by the plugin manager.
        """
    ...
    def test_plugin_instantiation_error_handling(self, mock_logging):
        """
        Test that the plugin manager handles exceptions during plugin instantiation by returning None and logging the error.
        """
